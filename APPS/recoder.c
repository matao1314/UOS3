...
//录音保存提示
const u8* recoder_save_rmd_tbl[GUI_LANGUAGE_NUM]=
{					  
...
{
 	gui_fill_rectangle(x-1,y-1,240,13,RECODER_MAIN_BKCOLOR);	//填充背景色
...
/////////////////////////////////////////////////////////////
	...
	{
 		res=window_msg_box(20,120,200,80,"",(u8*)recoder_save_rmd_tbl[gui_phy.language],12,0,0X03);
		if(res==1)//需要保存
		{
			wavhead->riff.ChunkSize=sectorsize*512+36;	//整个文件的大小-8;
	   		wavhead->data.ChunkSize=sectorsize*512;		//数据大小
